...
__all__ = ['AgentFrameworkProductManagementAgent', 'ResponseFormat', 'ChatServices', 'get_chat_completion_service']
...
class AgentFrameworkProductManagementAgent:
    ...
    def _get_agent_response(
        ...
        try:
            ...
            # This happens when the model doesn't return structured output
            return {
